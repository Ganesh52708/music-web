  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    async function fetchGenreTracks() {
      try {
        ...
        // Fetch Hindi songs
        const hindiTracks = await fetchTracksByLanguage("hindi", 10)
        
        // Fetch Bhojpuri songs
        const bhojpuriTracks = await fetchTracksByLanguage("bhojpuri", 10)
        
        // Fetch Haryanvi songs
        const haryanviTracks = await fetchTracksByLanguage("haryanvi", 10)
